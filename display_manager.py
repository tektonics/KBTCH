...
class BTCPriceMonitor:
    def __init__(self, price_file: str = "data/aggregate_price.json"):
...
class OHLCVMonitor:
    def __init__(self, data_file: str = "data/ohlcv_data.json"):
...
class BRTIManager:
    def __init__(self, script_path: str = "data/brti.py"):
        self.script_path = Path(script_path)
        self.process: Optional[subprocess.Popen] = None
        self.price_file = Path("data/aggregate_price.json")
...
class OHLCVManager:
    def __init__(self, script_path: str = "data/OHLCV.py"):
        self.script_path = Path(script_path)
        self.process: Optional[subprocess.Popen] = None
        self.data_file = Path("data/ohlcv_data.json")
...
class DisplayManager:
    ...
    def format_market_display(self, active_markets: List[MarketInfo], btc_price: float, 
        ...
        if ohlcv_data:
            ohlcv_line = self._format_ohlcv_analysis(ohlcv_data)
            if ohlcv_line:
